        ...
        <div className="rules-paper">
          ...
          <div className="grid">
            ...
            <div className="row">
              ...
              <p>Next, the priest selects someone they'd like to protect. The person chosen (which could be the priest himself) will survive if the werewolves had chosen to kill them. If a player gets selected by the werewolves, and then saved by the priest, the moderator will let the village know by announcing the news at the beginning of daytime.</p><br />

              <p>At the same time, the seer can ask if a particular player is a werewolf, and the moderator will answer.</p><br/>

              <h3>The Day</h3>
              <p>At the beginning of each day, the moderator announces the username of the player who has been killed, or that nobody died that night. The player who is killed is out of the game, and they do not reveal their role to the surviving villagers. </p><br/>
